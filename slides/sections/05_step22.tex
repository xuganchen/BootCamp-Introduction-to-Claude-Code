...
\begin{frame}[fragile]{\yob{LAB \#4: }Prompt: package the seam, with a repair loop}
...
\begin{frame}[fragile]{\yob{LAB \#5: }Prompt: parameterize, then sweep}
\begin{prompt}
...
\begin{frame}[fragile]{\yob{LAB \#6: }Prompt: parameterize, then sweep}
\begin{prompt}[basicstyle=\scriptsize\ttfamily\color{white}]
