...
\vs
\begin{itemize}
    \item Your parser is proven on \ybb{one} filing. A dataset is many.
    \begin{itemize}
        \item Today: generalize across quarters.
        \item Another dimension: generalize across BDCs.
    \end{itemize}
    \item You package what you learned as a \ybb{skill}, then sweep the whole history.
...
\begin{frame}[fragile]{Prompt: package the seam, with a repair loop}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{bdc_design_pharse2-3.png}
\end{center}
\end{frame}
...
\vs
\begin{center}
\includegraphics[width=0.85\textwidth]{bdc_design_pharse2-6.png}
\end{center}
\end{frame}
...
\begin{itemize}
    ...
    \item \ybb{50 of 88 filings (57\%)}, 37,197 positions;
    \ybb{30 of 34} from 2018 onward; \ybb{14 of 14} from 2023 onward.
\end{itemize}
...
\vs
\begin{wideitemize}
  \item Byte-identical through \ybb{45 filings} of edits. It kept
        a saved copy and diffed after every change.
  \item It also recorded a bug it \ybb{introduced} during the backfill, and how that surfaced.
\end{wideitemize}
\vs
