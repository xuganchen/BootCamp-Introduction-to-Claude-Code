...
\begin{enumerate}
    ...
    \item Be replicable: 22 minutes to author, 2 seconds to run.
...
\begin{wideitemize}
    ...
    \item The real question is not ``what may it do'' but \ybb{``what can it reach''}.
\end{wideitemize}
\end{frame}
...
\begin{wideitemize}
    ...
    \item Isolation is about \ybb{what is reachable}. It says nothing about what the
        agent does with what it can reach.
