...
\end{center}
\vs
We didn't ask for verification, but it invented a balance-sheet tie-out anyway.
\vs
\takeaway{If we stopped here, we would think the lesson was ``the prompt can be lazy''.}
\end{frame}
