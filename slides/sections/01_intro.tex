...
\begin{itemize}
  ...
  \begin{itemize}
      \item Antigravity CLI: Claim the student plan in \yb{\url{gemini.google/students/}} and install it from \yb{\url{antigravity.google/download}}
      \item Claude Code: Subscribe to a paid plan and install it from \yb{\url{code.claude.com/docs}}
  \end{itemize}
  \item \ybb{Then} \file{cd} into a project folder and type \file{claude} (or \file{agy}). That is all.
\end{itemize}
\vspace{-0.2em}
\begin{center}
