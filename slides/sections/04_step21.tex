...
\begin{frame}{\yob{LAB \#1: }Write down how you will know it worked, first}
\begin{columns}
...
\begin{frame}[fragile]{\yob{LAB \#2: }The prompt}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{bdc_design_pharse1-2.png}
\end{center}
\vspace{-1em}
...
\begin{frame}[fragile]{\yob{LAB \#3: }Run it with sub-agents}
\begin{prompt}
